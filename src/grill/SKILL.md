...
1. Run:
   ...
   If the command is not found, grill is not installed on this PATH — say so and
...
3. Record the result:
   - Picked letter L: `grill record <probe_id> --pick L`
   - Skipped: `grill record <probe_id> --skip`
   - Premise rejected: `grill record <probe_id> --wrong --objection
