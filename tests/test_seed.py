...
from grill.dialogue import Dialogue, Reply
from grill.llm import Completion, LLMError
from grill.seed import build_prompt, parse_seed
...
class TestQuotesAreVerified:
    ...
    def test_rejects_a_seed_where_no_quote_survives(self):
        ...
        said is exactly the generic question the design says gets grill
